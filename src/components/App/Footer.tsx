    ...
    <footer className="bg-blue-500 p-8 sm:px-12 md:px-24">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 sm:flex-row sm:gap-0">
        <div className="flex-1 text-slate-50">
          <h2 className="text-3xl font-bold drop-shadow">Flashcards</h2>
          <p className="mt-1 text-xl font-semibold">
            <a href="mailto:Info@flashcards.edu">Info@flashcards.edu</a>
            <br />
            Copyright &copy;{new Date().getFullYear()} Flashcards,
            <br />
            Designed by{" "}
